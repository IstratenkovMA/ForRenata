...
public class Main {
    public static void main(String[] args) {
        ...
        double[][] a = {{0, 8, -2, 0, 0, 0}, {0, -1, 6, -2, 0, 0}, {0, 0, 2, 10, -4, 0}, {0, 0, 0, -1, 6, 0}};
        double[] d = {6, 3, 8, 5};
        double[] pi = new double[a.length + 1];
        double[] qi = new double[a.length + 1];
        double[] xi = new double[a.length];
        pi[1] = Math.abs(a[0][2] / a[0][1]);
        qi[1] = Math.abs(-d[0] / a[0][1]);
